...
interface FacilityServiceSubscription {
  id: string;
  serviceName: string;
  facilityName: string;
  providerName: string;
...
export default function SubscriptionsFcTabScreen() {
  ...
  const subscriptions: FacilityServiceSubscription[] = [];
  ...
  const filteredSubscriptions = subscriptions.filter(subscription => {
    const matchesSearch = subscription.serviceName.toLowerCase().includes(searchQuery.toLowerCase()) ||
                         subscription.facilityName.toLowerCase().includes(searchQuery.toLowerCase()) ||
                         subscription.providerName.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  const getStatusColor = (status: FacilityServiceSubscription['status']) => {
    switch (status) {
      case 'active':
  ...
  const getStatusIcon = (status: FacilityServiceSubscription['status']): keyof typeof Ionicons.glyphMap => {
    switch (status) {
      case 'active':
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Manage your service subscriptions</Text>
          </View>
                    ...
                    >
                      ...
                      <View style={styles.subscriptionDetails}>
                        <View style={styles.subscriptionDetailRow}>
                          ...
                          <Text style={styles.subscriptionDetailText}>{subscription.facilityName}</Text>
                        </View>
                        <View style={styles.subscriptionDetailRow}>
                          <Ionicons name="person-outline" size={16} color={colors.text.secondary} />
                          <Text style={styles.subscriptionDetailText}>{subscription.providerName}</Text>
                        </View>
                        <View style={styles.subscriptionDetailRow}>
                          <Ionicons name="document-text-outline" size={16} color={colors.text.secondary} />
                          <Text style={styles.subscriptionDetailText}>{subscription.planName}</Text>
                        </View>
                      </View>
              ...
              <View style={styles.emptyState}>
                ...
                <Text style={styles.emptyStateText}>
                  {searchQuery
                    ...
                    : 'Your service subscriptions will appear here'}
                </Text>
              </View>
            </Card>
          )}
