...
const ALL_TABS: TabConfig[] = [
  ...
  { name: 'index', title: 'Home', icon: 'home', packages: ['marketplace'] },
  { name: 'search', title: 'Search', icon: 'search', packages: ['marketplace'] },
  { name: 'bookings', title: 'Bookings', icon: 'calendar', packages: ['marketplace'] },
  { name: 'messages', title: 'Messages', icon: 'chatbubbles', packages: ['marketplace'] },

  // Job Board tabs
  { name: 'browse-jobs', title: 'Browse', icon: 'briefcase', packages: ['job-board'] },
  { name: 'search-jobs', title: 'Search', icon: 'search', packages: ['job-board'] },
  ...
  { name: 'search-shop', title: 'Search', icon: 'search', packages: ['supplies'] },
  { name: 'orders', title: 'Orders', icon: 'receipt', packages: ['supplies'] },
  { name: 'my-supplies', title: 'My Supplies', icon: 'cube', packages: ['supplies'] },

  // Rentals tabs
  { name: 'browse-rentals', title: 'Browse', icon: 'home-outline', packages: ['rentals'] },
  { name: 'bookings-rentals', title: 'Bookings', icon: 'calendar', packages: ['rentals'] },
  { name: 'search-rentals', title: 'Search', icon: 'search', packages: ['rentals'] },
  ...
  { name: 'search-agencies', title: 'Search', icon: 'search', packages: ['agencies'] },
  ...
  { name: 'bookings-fc', title: 'Bookings', icon: 'calendar', packages: ['facility-care'] },
