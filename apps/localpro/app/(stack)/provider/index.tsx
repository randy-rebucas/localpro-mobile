...
import { useProviders } from '@localpro/marketplace';
    ...
    if (searchQuery) {
      filtered = filtered.filter(
        (provider: Provider) =>
          ...
          (provider.location && provider.location.toLowerCase().includes(searchQuery.toLowerCase()))
      );
    }
  ...
  const renderEmptyState = () => {
    ...
    return (
      <EmptyState
        ...
        subtitle="Check back later for new providers"
      />
    );
  };
    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <FlatList
        ...
        contentContainerStyle={[
          styles.listContent,
          filteredProviders.length === 0 && styles.emptyListContent,
        ]}
